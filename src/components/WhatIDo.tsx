        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CLOUD & DEVOPS</h3>
              <h4>Enterprise Cloud Platform Operations</h4>
              <p>
                DevOps specialist delivering highly available cloud solutions on
                Microsoft Azure and Kubernetes-based environments for enterprise clients.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Secure & Compliant Cloud Architecture</h4>
              <p>
                Building production-ready infrastructure with comprehensive monitoring,
                CI/CD automation, and security best practices for regulated environments.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
